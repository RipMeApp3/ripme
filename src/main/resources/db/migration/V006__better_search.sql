-- v6: better fts5 search, with English stemming

DROP TRIGGER IF EXISTS insert_remote_file_fts5;
DROP TRIGGER IF EXISTS delete_remote_file_fts5;
DROP TRIGGER IF EXISTS update_remote_file_fts5;
DROP TRIGGER IF EXISTS insert_album_fts5;
DROP TRIGGER IF EXISTS delete_album_fts5;
DROP TRIGGER IF EXISTS update_album_fts5;
DROP TRIGGER IF EXISTS insert_tag_fts5;
DROP TRIGGER IF EXISTS delete_tag_fts5;
DROP TRIGGER IF EXISTS update_tag_fts5;
DROP TABLE IF EXISTS remote_file_fts5;
DROP TABLE IF EXISTS album_fts5;
DROP TABLE IF EXISTS tag_fts5;
